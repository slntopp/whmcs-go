...
type GetSupportDepartmentsRequest struct {
	...
	// 	Optional
	IgnoteDeptAssignment bool `json:"ignore_dept_assignments"`
}
...
type GetTicketRequest struct {
	...
	// 	Optional
	RepliesSort string `json:"repliessort"`
}
...
type GetTicketAttachmentRequest struct {
	...
	// 	Required
	Type RelatedEntityType `json:"type"`
...
type GetTicketCountsRequest struct {
	// Pass as true to not adhere to the departments the API user is a member of.
	// 	Optional
	IgnoreDepartmentAssignments bool `json:"ignoreDepartmentAssignments"`

	// Pass as true to not adhere to the departments the API user is a member of.
	// 	Optional
	IncludeCountsByStatus bool `json:"includeCountsByStatus"`
}
...
type GetTicketsRequest struct {
	...
	// Pass as true to not adhere to the departments the API user is a member of.
	// 	Optional
	IgnoreDepartmentAssignments bool `json:"ignore_dept_assignments"`
}
